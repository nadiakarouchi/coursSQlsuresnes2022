...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 02 déc. 2021 à 15:30
...
CREATE TABLE `employes` (
  ...
  `service` varchar(30) DEFAULT NULL COMMENT 'services des employés',
  `date_embauche` date DEFAULT NULL COMMENT 'date d''embauche',
  `salaire` float DEFAULT NULL COMMENT 'salaires des employés'
...
(995, 'sidra', 'fasli', 'f', 'commerce', '2021-07-05', 2500);
